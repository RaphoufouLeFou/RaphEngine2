...
namespace raphEngine::objects
{
    ...
    void Shader::setIntArray(const std::string& name, int count,
                             int* value) const
    {
    ...
    void Shader::setFloatArray(const std::string& name, int count,
                               float* value) const
    {
    ...
    void Shader::setVec2Array(const std::string& name, int count,
